...
import appeng.tile.inventory.AppEngFilteredInvWrapper;
...
public class TileGrinder extends AEBaseInvTile implements ICrankable
{
	...
	private final IItemHandlerModifiable invExt = new AppEngFilteredInvWrapper(inv, new GrinderFilter());
	private int points;
	...
	{
		@Override
		public boolean allowExtract(IItemHandlerModifiable inv, int slotIndex, int amount) 
		{
			return slotIndex >= 3 && slotIndex <= 5;
		}

		@Override
		public boolean allowInsert(IItemHandlerModifiable inv, int slotIndex, ItemStack stack) 
		{
