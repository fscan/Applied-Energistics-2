...
public class TileCharger extends AENetworkPowerTile implements ICrankable, IGridTickable
{
	...
	{
		@Override
		public boolean allowInsert(IItemHandlerModifiable inv,  final int i, final ItemStack itemstack )
		{
		...
		@Override
		public boolean allowExtract(IItemHandlerModifiable inv, final int slotIndex, int amount )
		{
